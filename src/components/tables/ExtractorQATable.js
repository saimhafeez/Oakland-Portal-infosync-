...
const ExtractorQATable = (props) => {
  ...
  const fetchTableDataStats = () => {
    ...
    const apiURL = `${process.env.REACT_APP_SERVER_ADDRESS}/api/stats?job=QA-Extractor&uid=${props.user.uid}&lt=${tableDataStats.lessThanDate}&gt=${tableDataStats.greaterThanDate}`
