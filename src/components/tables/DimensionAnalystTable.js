...
const DimensionAnalystTable = (props) => {
  ...
  const fetchTableDataStats = () => {
    ...
    const apiURL = `http://139.144.30.86:8000/api/super_table?job=DimAna&lt=${tableDataStats.lessThanDate}&gt=${tableDataStats.greaterThanDate}&page=${tableDataStats.currentPage}&uid=${props.user.uid}`
