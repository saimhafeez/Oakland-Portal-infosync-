...
const ManagerDimensionsTable = (props) => {
    ...
    const fetchTableDataStats = () => {
        ...
        const apiURL = `http://139.144.30.86:8000/api/super_table?job=DimAna&lt=${tableDataStats.lessThanDate}&gt=${tableDataStats.greaterThanDate}&page=${tableDataStats.currentPage}`
    ...
    const fetchTableData = () => {
        ...
        const apiURL = `http://139.144.30.86:8000/api/super_table?job=DimAna&lt=${tableData.lessThanDate}&gt=${tableData.greaterThanDate}&page=${tableData.currentPage}`
        fetch(apiURL).then(res => res.json()).then((result) => {
            setTableData(pre => ({
                ...pre,
                isLoading: false,
