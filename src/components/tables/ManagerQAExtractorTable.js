...
const ManagerQAExtractorTable = (props) => {
    ...
    const fetchTableDataStats = () => {
        ...
        const apiURL = `http://139.144.30.86:8000/api/super_table?job=QA-Extractor&lt=${tableDataStats.lessThanDate}&gt=${tableDataStats.greaterThanDate}&page=${tableDataStats.currentPage}`
