...
const ManagerExtractorTable = (props) => {
    ...
    const fetchTableData = (currentPage = tableData.currentPage, productID = searchByID) => {
        ...
        var apiURL = `${process.env.REACT_APP_SERVER_ADDRESS}/api/super_table?job=Extractor&lt=${tableData.lessThanDate}&gt=${tableData.greaterThanDate}&page=${currentPage}`
    ...
    const fetchUserList = async () => {
        ...
        const q = query(usersCollectionRef, where("jdesc", "==", "Extractor"));
